...
<tr ><td>  <label><b>시작일시</b></label></td><td><input type="datetime-local"  class="w3-input w3-hover-light-grey" name="email" ><p/></td></tr>
<tr ><td>  <label><b>종료일시</b></label></td><td><input type="datetime-local"  class="w3-input w3-hover-light-grey" name="email" ><p/></td></tr>
<tr ><td>  <label><b>공구가격</b></label></td><td><input type="text"  class="w3-input w3-hover-light-grey" name="email" ><p/></td></tr>
<tr ><td><label><b>목표수량</b> </label></td><td><input type="text"  class="w3-input w3-hover-light-grey" name="bdate"><p/></td></tr>
