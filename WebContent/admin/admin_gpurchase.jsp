...
<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <jsp:include page="adminheader.jsp"></jsp:include>
  ...
  <form class="w3-container w3-section" action="addGproductPro" style="padding-left:50px;">
  <h4>공동구매 상품 등록</h4>
...
<td><input type="text" required="required" class="w3-input w3-hover-light-grey" name="price" ><p/></td></tr>
<tr ><td><label><b>목표수량</b> </label></td>
<td><input type="text" required="required" class="w3-input w3-hover-light-grey" name="goal"><p/></td></tr>
