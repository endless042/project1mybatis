...
<table class="w3-table w3-bordered  w3-bordered w3-small"  style="width:90%;" >
   ...
   <tr>
    ...
    <td  width="330">
       <input type="text"  class="w3-input w3-border-0 w3-hover-light-grey" style="width:300px;" size="10" maxlength="12" name="writer" value="${article.writer}"></td>
  </tr>
  <tr>
    ...
    <td width="330">
       ...
       <input type="text" size="40" maxlength="50" name="subject"  class="w3-input w3-border-0 w3-hover-light-grey" value="${article.subject}">
  ...
  <tr>
    ...
    <td  width="330">
       <input type="text" size="40" maxlength="30" name="email" class="w3-input w3-border-0 w3-hover-light-grey" value="${article.email}"></td>
  </tr>
  <tr>
   <td  width="70" class=" w3-center " ><label><b>내 용</b></label></td>
    <td  width="330" >
     <textarea name="content" rows="13"  cols="40" class="w3-input w3-border-0 w3-hover-light-grey">${article.content}</textarea> </td>
  </tr>
  <tr>
...
<tr>      
 ...
 <input type="hidden" name="boardid" value="${boardid}" >
  ...
  <input type="button" class="w3-button w3-hover-black" value="목록보기" OnClick="window.location='list?boardid=${boardid}'">
</td></tr></table>    
