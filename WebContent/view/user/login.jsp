...
<table align="center" width="100%" style="max-width:600px"><tr ><td>
 <div class="w3-card-4 " style="max-width:600px" >
      <form class="w3-container" method="post" action="loginPro">
      ...
      <div class="w3-container w3-border-top w3-padding-16 ">
       ...
       <span class="w3-right w3-padding "> <a href="#">비밀번호</a>를 잊으셨나요?</span> <span class="w3-right w3-padding "><a href="join">회원가입</a></span>
      </div>
  </td></tr>
  </table>
</div>
