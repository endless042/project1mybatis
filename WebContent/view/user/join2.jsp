...
<form class="w3-container w3-section" action="joinPro" style="padding-left:50px;">
  <h4>회원 가입</h4>
  ...
  <!--  <tr><td colspan="2"><span class="w3-small w3-left"> <b><font color="red">&nbsp;&nbsp;&nbsp;*</font></b> 표시가 된 항목은 필수 입력입니다. </span></td></tr> -->
   <tr><td >
  <label><b>이름<font color="red">&nbsp;&nbsp;&nbsp;*</font></b></label></td><td align="left">
...
<tr ><td>  <label><b>이메일<font color="red">&nbsp;&nbsp;&nbsp;*</font></b></label></td><td> <input type="email" required="required" class="w3-input w3-hover-light-grey" name="email"  ><p/></td></tr>
