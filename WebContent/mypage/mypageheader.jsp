...
<div class="w3-container w3-padding-64"  width="100%"  >
 ...
 <div class="w3-card-4 w3-center w3-padding-24 w3-section"  style="padding:50px;" >
    ...
    <button  class="w3-bar-item w3-button tablink w3-hide-small <%=(select!=null&&select.equals("order"))?"w3-green":"" %> " onclick="location.href='orderlist?select=order';">참여정보</button>
    <button  class="w3-bar-item w3-button tablink w3-hide-small <%=(select!=null&&select.equals("pay"))?"w3-green":"" %> " onclick="location.href='paylist?select=pay';">결제내역</button>
