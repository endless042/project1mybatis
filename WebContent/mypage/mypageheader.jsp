...
<div class="w3-container w3-padding-64"  width="100%"  >
 ...
 <div class="w3-card-4 w3-center w3-padding-24"  style="max-width:900px; padding:20px;" >
    ...
    <button style="width:25%" class="w3-bar-item w3-button tablink w3-hide-small <%=(select!=null&&select.equals("cart"))?"w3-green":"" %> " onclick="location.href='cart?select=cart';">찜목록</button>
